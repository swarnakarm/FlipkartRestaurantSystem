package com.flipkart.restaurant.main;
...
public class Main {
	...
	public static void main(String[] args) throws Exception{
		...
		Restaurant r2 = new Restaurant("r2", 2, 2);
		...
		orderItems1.add(new OrderItem("i2",1));
		 ...
		 for(RestaurantItem restItem :orderDtl1.getRestItems()){
			 System.out.println(restItem.getRestaurant().getName()+" -- "+ restItem.getItem().getItemName() +" --- "+restItem.getCount() );
		 }
